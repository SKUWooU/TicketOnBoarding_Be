...
$resultText = 'CHECKOUT_RESULT {"schemaVersion":2,"scenario":"distributed","targetRatePerSecond":5,"duration":"10s","thresholdsEnforced":true,"iterations":50,"droppedIterations":0,"checkoutConfirmed":50,"expectedContention":0,"unexpectedNonSuccessful":0,"unexpectedFailureRate":0,"checkoutDurationMs":{"p95":20,"average":10},"maxObservedVus":5,"maxAllocatedVus":20,"preAllocatedVus":20,"configuredMaxVus":100}'
...
Assert-Equal $result.schemaVersion 2 'schema v2 parser'
$legacyV1Text = 'CHECKOUT_RESULT {"schemaVersion":1,"scenario":"distributed","targetRatePerSecond":5,"duration":"10s","thresholdsEnforced":true,"iterations":50,"droppedIterations":0,"checkoutConfirmed":50,"expectedContention":0,"unexpectedNonSuccessful":0,"unexpectedFailureRate":0,"checkoutDurationMs":{"p95":20,"average":10}}'
Assert-Equal (ConvertFrom-CheckoutK6Result $legacyV1Text).schemaVersion 1 'legacy schema v1 parser'
Assert-Throws { ConvertFrom-CheckoutK6Result ($resultText -replace '"maxObservedVus":5,', '') }
