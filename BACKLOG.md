...
| 8-INSTANCE | BE | 단일 instance에서 검증한 JWT·hold·Checkout 전이가 요청 분산 경계에서도 수렴하는지 확인되지 않았다 | shared JWT key, loopback proxy, instance별 metric, 2,000석 fixture final snapshot | 운영 LB·Kafka·outbox·Redis lock 선제 도입 | 진행 중 ([#150](https://github.com/SKUWooU/TicketOnBoarding_Be/issues/150)) |
