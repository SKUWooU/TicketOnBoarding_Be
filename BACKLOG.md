...
| 6 | BE/FE | 예약·결제·취소 중복 요청의 결과가 안정적이지 않다 | 중복 key, 응답 유실, payload 충돌 fixture | 브로커 선제 도입 | 취소 순차 중복 기준선 진행 ([#21](https://github.com/SKUWooU/TicketOnBoarding_Be/issues/21)) |
