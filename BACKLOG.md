...
| 7 | BE | 고경합 병목 위치가 측정되지 않았다 | 2,000석 fixture·k6·Actuator 실행 기반 구성 후 단계별 TPS·p95·오류율, lock wait, Hikari 시계열 측정 | 운영 SLA 주장 | 측정 기반 완료 ([#47](https://github.com/SKUWooU/TicketOnBoarding_Be/issues/47)), 경합 오류 HTTP 409 계약 구현·검증 완료 ([#49](https://github.com/SKUWooU/TicketOnBoarding_Be/issues/49), [PR #50](https://github.com/SKUWooU/TicketOnBoarding_Be/pull/50)); 시계열 수집·단계별 기준선 후속 |
