...
| 동일 예약 중복 취소의 재고 중복 복구 | Issue #21 fixture의 순차 중복과 start latch 기반 동시 중복 각 3회 | 취소 transaction, 예약 `PESSIMISTIC_WRITE`, 허용 상태 검증, 회차 잔여 원자 증가 | 정상 1회·순차 3회·동시 3회·직접 상태 전이 거부, 대상 8개·전체 27개 invocation | 모든 중복 시나리오 잔여 24·불변식 충족, `결제완료` 직접 취소는 상태·점유·잔여 23 유지 | [BE #31](https://github.com/SKUWooU/TicketOnBoarding_Be/issues/31) |
