...
| Reviewer 결과 전달과 merge 승인 반복 | 기존 WORKFLOW의 Issue별 사용자 최종 승인, 활성 CI 없음 | Java 21 Backend CI와 actor·40자리 HEAD·판정·CI 기반 squash merge gate | actionlint, PR Ubuntu `Backend test`, stale·latest HEAD synthetic comment | stale HEAD 거부, 최신 HEAD·CI 기반 squash merge와 branch 삭제 성공; 연결 Issue 명시적 종료 보완·E2E 진행 | [BE #23](https://github.com/SKUWooU/TicketOnBoarding_Be/issues/23) / [PR #24](https://github.com/SKUWooU/TicketOnBoarding_Be/pull/24) / [BE #25](https://github.com/SKUWooU/TicketOnBoarding_Be/issues/25) / [PR #26](https://github.com/SKUWooU/TicketOnBoarding_Be/pull/26) / [BE #27](https://github.com/SKUWooU/TicketOnBoarding_Be/issues/27) / [PR #28](https://github.com/SKUWooU/TicketOnBoarding_Be/pull/28) |
